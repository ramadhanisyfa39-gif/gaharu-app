...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/work-order', [WorkOrderController::class, 'index'])->name('wo.index');
    Route::get('/work-order/create/{id}', [WorkOrderController::class, 'create'])->name('wo.create');
    Route::post('/work-order/store', [WorkOrderController::class, 'store'])->name('wo.store');
