    ...
    <div class="container py-4">
        <div class="card shadow border-0 rounded-3 mb-4">
            <div class="card-header bg-info text-white py-3">
                <h5 class="mb-0 fw-bold"><i class="fas fa-info-circle me-2"></i>Informasi Dokumen Referensi POS</h5>
            </div>
            <div class="card-body">
                <div class="row">
        ...
        <div class="card shadow border-0 rounded-3">
            <div class="card-header bg-light border-bottom py-3">
                <h5 class="mb-0 fw-bold text-secondary"><i class="fas fa-list me-2"></i>Rincian Posting Item Jurnal POS</h5>
            </div>
            ...
            <div class="card-footer bg-white py-3 d-flex justify-content-end">
                <a href="{{ route('laporan.jurnal-penjualanpos.index') }}" class="btn btn-secondary fw-bold px-4 shadow-sm">
                    <i class="fas fa-arrow-left me-1"></i> Kembali ke Riwayat POS
                </a>
            </div>
        </div>
    </div>
