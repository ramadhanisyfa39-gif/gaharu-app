                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="jurnal-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <select name="details[{{ $index }}][coa_id]" class="form-select" required>
                                        <option value="">-- Pilih Akun --</option>
                                        @foreach($coas as $coa)
                                        <option value="{{ $coa->id }}" {{ (isset($oldValue['coa_id']) && $oldValue['coa_id'] == $coa->id) ? 'selected' : '' }}>
                                            {{ $coa->kode }} - {{ $coa->nama }}
                                        </option>
                                        @endforeach
                                    </select>
...
<script>
    ...
    function addRow() {
        ...
        row.innerHTML = `
            <td>
                <select name="details[${rowIndex}][coa_id]" class="form-select" required>
                    <option value="">-- Pilih Akun --</option>
                    @foreach($coas as $coa)
