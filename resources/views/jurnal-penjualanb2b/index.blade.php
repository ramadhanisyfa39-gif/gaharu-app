<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Modul Jurnal Khusus Penjualan B2B
        </h2>
    </x-slot>
    ...
    <div class="container py-4">
        ...
        <div class="card shadow border-0 rounded-3 mb-5">
            <div class="card-header bg-warning text-dark py-3 d-flex align-items-center justify-content-between">
                ...
                <span class="badge bg-dark text-white">{{ count($pesananBelum) }} Invoice</span>
            </div>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="badge bg-light text-dark border font-monospace px-2.5 py-1.5 fs-6">{{ $p->kode_pesanan }}</span></td>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('jurnal-penjualanb2b.create', $p->id) }}" class="btn btn-sm btn-primary fw-bold px-3 shadow-sm">
                            ...
                            <tr>
                                <td colspan="5" class="text-center text-muted py-4">
                                    <i class="fas fa-check-double text-success me-2"></i>Semua transaksi penjualan B2B dari gudang sudah selesai dijurnal.
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
                    ...
                    <table class="table table-bordered table-hover align-middle mb-0">
                        <thead class="table-light text-secondary small text-uppercase fw-bold">
                            <tr>
                                ...
                                <th class="py-3" style="width: 10%">No. Jurnal (Ref)</th>
