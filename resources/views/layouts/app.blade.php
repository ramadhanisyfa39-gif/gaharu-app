...
.menu-parent {
    ...
    align-items: center;
    padding: 12px 20px;             /* rata kiri, tidak center */
    color: #ffffff;
    font-weight: 700;
    font-size: 13px;
...
.menu-parent.active-menu-root {
    color: #d88656;                 /* terracota saat hover / aktif */
}
...
.submenu {
    ...
    padding-left: 0;
    margin: 0 0 8px 0;
    background: #545454;            /* sedikit lebih gelap dari sidebar */
}
...
.submenu a {
    display: block;
    padding: 9px 20px 9px 44px;    /* indent 44px vs parent 20px */
    text-decoration: none;
    color: #e0e0e0;
    font-size: 13.5px;
    font-weight: 400;
...
.submenu a.active {
    ...
    padding-left: 41px;            /* kompensasi border 3px */
}
...
.logout-btn:hover { background: #c87443; }
...
/* ── BUTTON & BADGE ── */
.btn-primary { background: #d88656 !important; border: none !important; border-radius: 8px; }
.btn-primary:hover { background: #c87443 !important; }
.badge.bg-success { background: #d88656 !important; }
</style>
</head>
